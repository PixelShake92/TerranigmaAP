...
a = Analysis(
    ...
    binaries=[],
    datas=[],
    hiddenimports=['terranigma_randomizer.randomizers.chest', 'terranigma_randomizer.randomizers.shop', 'terranigma_randomizer.randomizers.integration', 'terranigma_randomizer.utils.rom', 'terranigma_randomizer.utils.logic', 'terranigma_randomizer.utils.spoilers', 'terranigma_randomizer.constants.items', 'terranigma_randomizer.constants.chests', 'terranigma_randomizer.constants.shops', 'terranigma_randomizer.constants.progression', 'tkinter', 'tkinter.filedialog', 'tkinter.ttk'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
